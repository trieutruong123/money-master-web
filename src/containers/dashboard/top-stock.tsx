...
export default function TopStock() {
  ...
  const fetchData=async function(){
    ...
    setTopCoins( rawData.data.coins.map((rawCoin: any, index: number) => {
    ...
    }).sort((coina:any,coinb:any)=>{return coina.total-coinb.total}).slice(0,4));
  }
  ...
  return (
    ...
    <Grid container spacing={3}>
      ...
      {topCoins&&topCoins.map((coin: any) => (
