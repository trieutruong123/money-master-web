...
const CSDProfitLossChart = observer(() => {
  ...
  const handleSelectedTypeChange = async (event: SelectChangeEvent) => {
    customAssetsDetailStore.setProfitLossSelection(
      'period',
      event.target.value as any,
    );
    customAssetsDetailStore.fetchCustomAssetProfitLoss();
  };
    ...
    <>
      <Suspense fallback={<HypnosisLoading />}>
        ...
        >
            ...
            <Stack mt="8px" direction="row">
              <Button
                sx={{
                  ...
                  fontSize: '1.2rem',
                  display:
                    customAssetsDetailStore.profitLossSelection.type === 'line'
                      ? 'none'
                      : 'inherit',
                }}
                onClick={() =>
                  customAssetsDetailStore.setProfitLossSelection('type', 'line')
                }
                variant="outlined"
              ...
              <Button
                sx={{
                  ...
                  fontSize: '1.2rem',
                  display:
                    customAssetsDetailStore.profitLossSelection.type === 'bar'
                      ? 'none'
                      : 'inherit',
                }}
                onClick={() =>
                  customAssetsDetailStore.setProfitLossSelection('type', 'bar')
                }
                variant="outlined"
          ...
          <Suspense fallback={<></>}>
            {customAssetsDetailStore.profitLossList.length > 0 ? (
              <>
                <Box
                  display={
                    customAssetsDetailStore.profitLossSelection.type === 'bar'
                ...
                >
                  <LineChart
                    data={customAssetsDetailStore.profitLossList}
                    currencyCode={
...
export default CSDProfitLossChart;
