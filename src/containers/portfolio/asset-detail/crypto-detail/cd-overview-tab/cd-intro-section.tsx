...
interface IProps {
  assetDetail: CryptoItem | undefined;
  content: any
}

const CDIntroSection = ({ assetDetail, content }: IProps) => {
        ...
        >
          <Stack direction="column" spacing={1}>
            ...
            <Grid
              ...
              justifyContent="center"
            >
              <Typography variant="body1">{content.introSection.name} @ {content.introSection.avgPrice}: &nbsp;</Typography>
