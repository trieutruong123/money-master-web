import { CardHeader, Card, FormControl, MenuItem, Select,InputLabel, useMediaQuery, useTheme } from '@mui/material';
import { observer } from 'mobx-react-lite';
import { Suspense } from 'react';
import { HypnosisLoading } from 'shared/components';
import { cryptoDetailStore, stockDetailStore } from 'shared/store';
import CDLineChart from './cd-line-chart';
    ...
    <>
        <Suspense fallback={<HypnosisLoading />}>
          ...
          >
            ...
            <CDLineChart data={cryptoDetailStore.profitLossList} />
          </Card>
        </Suspense>
    </>
  );
