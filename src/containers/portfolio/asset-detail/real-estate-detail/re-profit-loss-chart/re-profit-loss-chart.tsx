      ...
      <>
        <Suspense fallback={<HypnosisLoading />}>
          ...
          >
            ...
            {realEstateDetailStore.profitLossList &&
            realEstateDetailStore.profitLossList.length > 0 ? (
              <CSDLineChart data={realEstateDetailStore.profitLossList} />
            ) : (
              <></>
            )}
          </Card>
