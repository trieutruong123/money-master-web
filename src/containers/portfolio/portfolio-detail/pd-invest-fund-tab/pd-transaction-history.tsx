...
const PDTransactionHistory = observer(
  ({ transactionHistory, content }: IProps) => {
    ...
    const handlePageChange = async (pageNumber: number) => {
      ...
      if (pageNumber == count) {
        ...
        const endDate = portfolioDetailStore.investFundTransactionSelection
          ...
          : null;
        const data =
          await portfolioDetailStore.fetchInvestFundTransactionHistory({
